...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, RequestObject> requestObjectProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, RequestObject> requestObjectKafkaTemplate() {
        return new KafkaTemplate<>(requestObjectProducerFactory());
    }
}
