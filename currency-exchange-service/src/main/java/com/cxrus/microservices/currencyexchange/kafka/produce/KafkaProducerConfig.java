...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, ExchangeValue> currencyExchangeProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, ExchangeValue> currencyExchangeKafkaTemplate() {
        return new KafkaTemplate<>(currencyExchangeProducerFactory());
    }
}
